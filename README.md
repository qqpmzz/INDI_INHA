# 🎮 Lost Spells - Magic Adventure Game# 🎮 Lost Spells - Magic Adventure Game# 🎮 Lost Spells - Magic Adventure Game
...
**Lost Spells**는 Unity로 개발되는 픽셀 아트 스타일의 마법 어드벤처 게임입니다. 현재 저장소의 웹 UI는 Unity 구현 전 프로토타입 및 디자인 확인용으로 제작되었습니다.> Unity 기반 마법 어드벤처 게임 개발 프로젝트> Unity 기반 마법 어드벤처 게임 개발 프로젝트
...
- 🎯 **게임 엔진**: Unity (PC/모바일 대응)**Lost Spells**는 Unity로 개발되는 픽셀 아트 스타일의 마법 어드벤처 게임입니다. 현재 저장소의 웹 UI는 Unity 구현 전 프로토타입 및 디자인 확인용으로 제작되었습니다.**Lost Spells**는 Unity로 개발되는 픽셀 아트 스타일의 마법 어드벤처 게임입니다. 현재 저장소의 웹 UI는 Unity 구현 전 프로토타입 및 디자인 확인용으로 제작되었습니다.
...
게임 시작 → 메인 메뉴 → [상점/설정] → 게임 모드 선택 → 스토리 모드 → 챕터 선택 → 난이도 선택 → 게임 플레이- 🎯 **게임 엔진**: Unity (PC/모바일 대응)- � **게임 엔진**: Unity (PC/모바일 대응)
...
- **게임 시작**: 타이틀 화면 및 진입점- 🌟 **장르**: Magic Adventure Game- 🌟 **장르**: Magic Adventure Game

- **메인 메뉴**: 게임 시작, 상점, 설정, 나가기

- **상점**: 부활석/룬석 구매 시스템 (달러 결제)- 📋 **개발 단계**: UI 프로토타이핑 및 요구사항 분석 단계- 📋 **개발 단계**: UI 프로토타이핑 및 요구사항 분석 단계
...
└── ui/                                 # 웹 프로토타입 (Unity 참고용)### 주요 화면 구성### 주요 화면 구성

    ├── game-start/                     # 게임 시작 화면

    ├── main-menu/                      # 메인 메뉴- **게임 시작**: 타이틀 화면 및 진입점- **게임 시작**: 타이틀 화면 및 진입점

    ├── shop/                           # 상점 시스템

    ├── settings/                       # 설정 화면- **메인 메뉴**: 게임 시작, 상점, 설정, 나가기- **메인 메뉴**: 게임 시작, 상점, 설정, 나가기

    ├── game-mode/                      # 게임 모드 선택

    ├── story-mode/                     # 스토리 모드- **상점**: 부활석/룬석 구매 시스템 (달러 결제)- **상점**: 부활석/룬석 구매 시스템 (달러 결제)

    ├── chapter-select/                 # 챕터 선택

    ├── difficulty-select/              # 난이도 선택- **설정**: 오디오/그래픽/게임플레이 설정- **설정**: 오디오/그래픽/게임플레이 설정
...
### 실행 방법## 🛠️ 현재 저장소 구성## 🛠️ 현재 저장소 구성

1. `ui/game-start/index.html`을 브라우저에서 열기

2. 각 화면을 순서대로 탐색하며 UI/UX 확인

3. Unity 개발 시 참고 자료로 활용
...
cd INDI_INHA### 📁 프로젝트 구조### 📁 프로젝트 구조



# 프로토타입 실행 (브라우저에서 열기)

start ui/game-start/index.html    # Windows

`````````



### 프로토타입 주요 기능INDI_INHA/INDI_INHA/

- ✅ **완전한 UI 플로우**: 모든 화면 간 이동 구현

- ✅ **상점 시스템**: 부활석/룬석 구매 (달러 결제)├── README.md                           # 프로젝트 개요├── README.md                           # 프로젝트 개요

- ✅ **설정 시스템**: 오디오/그래픽/게임플레이 설정

- ✅ **반응형 디자인**: 다양한 해상도 대응├── docs/├── docs/
...
- **[Unity_UI_Requirements.md](docs/Unity_UI_Requirements.md)**: 상세한 UI 요구사항 명세서└── ui/                                 # 웹 프로토타입 (Unity 참고용)└── ui/                                 # 웹 프로토타입 (Unity 참고용)
...
- [ ] Canvas 기반 UI 시스템 구축    │   ├── index.html    │   ├── index.html

- [ ] 화면 해상도 대응 UI 스케일링

- [ ] 게임 진행 상태 저장 시스템    │   ├── style.css    │   ├── style.css

- [ ] 챕터 해제 상태 관리

- [ ] 플레이어 스탯 및 재화 관리    │   └── script.js    │   └── script.js

- [ ] 상점 결제 시스템 연동

- [ ] 설정 데이터 영속화    ├── main-menu/                      # 메인 메뉴    ├── main-menu/                      # 메인 메뉴
...
- **주요 색상**: 보라색 그라데이션 (`#4B0082` → `#8A2BE2`)    │   └── script.js    │   └── script.js

- **HP 바**: 빨강→노랑→초록 그라데이션

- **MP 바**: 파랑→하늘색 그라데이션    ├── shop/                           # 상점 시스템    ├── shop/                           # 상점 시스템
...
- **플레이어**: 32x48px (마법사 - 보라 모자, 파란 로브)    │   ├── style.css    │   ├── style.css
...
- 캐릭터 Idle 애니메이션 (상하 움직임)    ├── settings/                       # 설정 화면    ├── settings/                       # 설정 화면

- HP/MP 바 변화 애니메이션

- 버튼 호버 효과    │   ├── index.html    │   ├── index.html
...
**부활석 (💎)**    ├── game-mode/                      # 게임 모드 선택    ├── game-mode/                      # 게임 모드 선택

- 1개: $5.00

- 3개: $10.00 (33% 할인)    ├── story-mode/                     # 스토리 모드    ├── story-mode/                     # 스토리 모드
...
- 1개: $5.00      ├── difficulty-select/              # 난이도 선택    ├── difficulty-select/              # 난이도 선택

- 3개: $10.00 (33% 할인)

- 10개: $20.00 (60% 할인)    └── game-play/                      # 게임플레이 화면    └── game-play/                      # 게임플레이 화면
...
## ⚙️ 설정 시스템 명세## 🎮 웹 프로토타입 확인 방법## 🎮 웹 프로토타입 확인 방법
...
- 마스터/BGM/SFX 볼륨 슬라이더### 실행 방법### 실행 방법



### 그래픽 설정1. `ui/game-start/index.html`을 브라우저에서 열기1. `ui/game-start/index.html`을 브라우저에서 열기

- 품질: 저/중/고/울트라

- 해상도 선택2. 각 화면을 순서대로 탐색하며 UI/UX 확인2. 각 화면을 순서대로 탐색하며 UI/UX 확인
...
- **실시간 전투**: 빠른 액션과 전략적 사고cd INDI_INHAcd INDI_INHA
...
### 플레이어 시스템# 프로토타입 실행 (브라우저에서 열기)# 프로토타입 실행 (브라우저에서 열기)

- **마법사 캐릭터**: 32x48px 픽셀 아트

- **성장 시스템**: 레벨업 및 능력치 향상start ui/game-start/index.html    # Windowsstart ui/game-start/index.html    # Windows
...
- **Chapter 1**: The Beginning (시작 챕터)# xdg-open ui/game-start/index.html  # Linux# xdg-open ui/game-start/index.html  # Linux
...
- **Unity 2022.3 LTS** 이상- ✅ **완전한 UI 플로우**: 모든 화면 간 이동 구현- ✅ **완전한 UI 플로우**: 모든 화면 간 이동 구현



### 필요 패키지- ✅ **상점 시스템**: 부활석/룬석 구매 (달러 결제)- ✅ **상점 시스템**: 부활석/룬석 구매 (달러 결제)

- UI Toolkit (권장) 또는 Legacy UI System

- TextMeshPro- ✅ **설정 시스템**: 오디오/그래픽/게임플레이 설정- ✅ **설정 시스템**: 오디오/그래픽/게임플레이 설정

- Unity Analytics (선택사항)

- Unity IAP (상점 시스템용)- ✅ **반응형 디자인**: 다양한 해상도 대응- ✅ **반응형 디자인**: 다양한 해상도 대응



### 개발 도구- ✅ **키보드/마우스 지원**: Unity 입력 시스템 참고용- ✅ **키보드/마우스 지원**: Unity 입력 시스템 참고용
...
- ✅ 웹 프로토타입 완성### 요구사항 문서### 요구사항 문서

- ✅ UI 요구사항 명세서 작성

- ✅ 디자인 시스템 정의- **[Unity_UI_Requirements.md](docs/Unity_UI_Requirements.md)**: 상세한 UI 요구사항 명세서- **[Unity_UI_Requirements.md](docs/Unity_UI_Requirements.md)**: 상세한 UI 요구사항 명세서



### Phase 2: Unity 이식 (예정)- **[UI_Hierarchy_Structure.md](docs/UI_Hierarchy_Structure.md)**: Unity Canvas 계층 구조 가이드- **[UI_Hierarchy_Structure.md](docs/UI_Hierarchy_Structure.md)**: Unity Canvas 계층 구조 가이드
...
- [ ] 캐릭터 컨트롤러- [ ] Canvas 기반 UI 시스템 구축- [ ] Canvas 기반 UI 시스템 구축

- [ ] 전투 시스템

- [ ] 스킬 시스템- [ ] 화면 해상도 대응 UI 스케일링- [ ] 화면 해상도 대응 UI 스케일링



### Phase 4: 시스템 통합 (예정)- [ ] 게임 진행 상태 저장 시스템- [ ] 게임 진행 상태 저장 시스템

- [ ] 상점 시스템 구현

- [ ] 저장/로드 시스템- [ ] 챕터 해제 상태 관리- [ ] 챕터 해제 상태 관리
...
- [ ] 성능 최적화- [ ] 상점 결제 시스템 연동- [ ] 상점 결제 시스템 연동

- [ ] 모바일 대응

- [ ] 테스트 및 디버깅- [ ] 설정 데이터 영속화- [ ] 설정 데이터 영속화



## 📊 기술 스택- [ ] 모바일 터치 입력 대응- [ ] 모바일 터치 입력 대응
...
- **애니메이션**: Animator, DOTween## 🎨 디자인 시스템## 🎨 디자인 시스템
...
### 아트 파이프라인### 색상 팔레트### 색상 팔레트

- **픽셀 아트**: 32x48px 캐릭터, 16x16px 타일

- **스프라이트 아틀라스**: 메모리 최적화- **주요 색상**: 보라색 그라데이션 (`#4B0082` → `#8A2BE2`)- **주요 색상**: 보라색 그라데이션 (`#4B0082` → `#8A2BE2`)
...
- [Unity Learn](https://learn.unity.com/)- **배경**: 다크 테마 (검정/회색 기반)- **배경**: 다크 테마 (검정/회색 기반)
...
### 픽셀 아트 리소스### 캐릭터 규격### 캐릭터 규격

- [Aseprite Tutorial](https://www.aseprite.org/docs/)

- [Pixel Art Academy](https://pixelartacademy.com/)- **플레이어**: 32x48px (마법사 - 보라 모자, 파란 로브)- **플레이어**: 32x48px (마법사 - 보라 모자, 파란 로브)



## 📞 연락처 및 기여- **적 캐릭터**: 32x48px (다양한 디자인)- **적 캐릭터**: 32x48px (다양한 디자인)
...
- **이슈 리포트**: GitHub Issues를 통해 버그 리포트 및 기능 요청### UI 애니메이션### UI 애니메이션



### 기여 방법- 캐릭터 Idle 애니메이션 (상하 움직임)- 캐릭터 Idle 애니메이션 (상하 움직임)

1. 프로젝트 Fork

2. Feature 브랜치 생성- HP/MP 바 변화 애니메이션- HP/MP 바 변화 애니메이션

3. 변경사항 커밋

4. Pull Request 생성- 버튼 호버 효과- 버튼 호버 효과
...
MIT License - 자세한 내용은 [LICENSE](LICENSE) 파일을 참조하세요.## 💰 상점 시스템 명세## 💰 상점 시스템 명세
...
> 💡 **참고**: 현재 웹 프로토타입은 Unity 개발의 디자인 참고 자료입니다. 실제 게임은 Unity 엔진으로 구현될 예정입니다.### 상품 구성### 상품 구성



> 🎮 **시작하기**: `ui/game-start/index.html`을 브라우저에서 열어서 프로토타입을 체험해보세요!**부활석 (💎)****부활석 (💎)**
